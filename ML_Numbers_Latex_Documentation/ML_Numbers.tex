...
Στην περίπτωση αυτή κάθε βάρος και bias συμβάλει σε κάθε $y_i$ του output layer και επομένως η μερική παράγωγος του loss προς αυτά θα είναι πιο σύνθετη. Συγκεκριμένα για τα βαρη και biases του $l-1$ layer θα έχουμε
